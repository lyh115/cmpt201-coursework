 ...
 * OPTIONAL:
 *   You may want to use this macro or snprintf() to format error/help messages.
 *
 * Example:
 ...
 * Both arguments must be string constants, not variables.
 * OPTIONAL:
 *   This macro shows the exact format required. You may use `snprintf()` as
 *   follows:
 *
 * Example:
 *
 * char formatted[BUFFER_SIZE];
 * snprintf(formatted, sizeof(formatted), FORMAT_HISTORY("%d", "%s"), i,
 *   str);
